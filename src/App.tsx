...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <section className="region-section"><div className="section-title"><div><p className="eyebrow">REGION SNAPSHOT</p><h2>Inventory footprint</h2></div><span className="muted">Aggregated by region · click a marker to filter</span></div><CoverageMap totals={regionTotals} selectedRegion={filters.region} onSelect={(region) => updateFilter('region', filters.region === region ? '' : region)} /></section>
